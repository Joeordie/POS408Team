...
Partial Public Class Database1DataSet
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddTable1Row(ByVal FName As String, ByVal LName As String, ByVal Phone As String, ByVal email As String) As Table1Row
            Dim rowTable1Row As Table1Row = CType(Me.NewRow,Table1Row)
            Dim columnValuesArray() As Object = New Object() {Nothing, FName, LName, Phone, email}
...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `FName` IS NULL) OR (`FNam"& _ 
                "e` = ?)) AND ((? = 1 AND `LName` IS NULL) OR (`LName` = ?)) AND ((? = 1 AND `Pho"& _ 
                "ne` IS NULL) OR (`Phone` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)"& _ 
                "))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`FName`, `LName`, `Phone`, `email`) VALUES (?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `FName` = ?, `LName` = ?, `Phone` = ?, `email` = ? WHERE ((`I"& _ 
                "D` = ?) AND ((? = 1 AND `FName` IS NULL) OR (`FName` = ?)) AND ((? = 1 AND `LNam"& _ 
                "e` IS NULL) OR (`LName` = ?)) AND ((? = 1 AND `Phone` IS NULL) OR (`Phone` = ?))"& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, FName, LName, Phone, email FROM Table1"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT * FROM Table1"
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As Database1DataSet.Table1DataTable) As Integer
        ...
        Public Overloads Overridable Function GetDataBy() As Database1DataSet.Table1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Dim dataTable As Database1DataSet.Table1DataTable = New Database1DataSet.Table1DataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_FName As String, ByVal Original_LName As String, ByVal Original_Phone As String, ByVal Original_email As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal FName As String, ByVal LName As String, ByVal Phone As String, ByVal email As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal FName As String, ByVal LName As String, ByVal Phone As String, ByVal email As String, ByVal Original_ID As Integer, ByVal Original_FName As String, ByVal Original_LName As String, ByVal Original_Phone As String, ByVal Original_email As String) As Integer
            If (FName Is Nothing) Then
